...
| **`POST`** | `/employees/import-json` | Validate uploaded JSON structure |
| **`POST`** | `/employees/bulk-create` | Validate multiple employee records |
...
| **`GET`** | `/employees/export/csv` | Limit CSV export requests |
| **`GET`** | `/employees/export/json` | Limit JSON export requests |
| **`POST`** | `/employees/import-json` | Limit large file uploads |
...
| **`GET`** | `/employees/export/csv` | Export employee dataset as CSV |
| **`GET`** | `/employees/export/json` | Export employee dataset as JSON |
| **`GET`** | `/employees/export/excel` | Export employee dataset as Excel |
| **`GET`** | `/employees/export/pdf` | Export employee analytics report as PDF |
| **`POST`** | `/employees/import-json` | Import employee dataset using JSON |
